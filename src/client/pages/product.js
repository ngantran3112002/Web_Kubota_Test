                    ...
                    <div className="row h-pt-cas">
                        ...
                        <div className="col-md-4 col-sm-6 wow fadeInUp "
                            ...
                            <a href="src/client/pages/product" className="item smooth">
                                ...
                                />
                                <div className="single-content text-center hiii">
                                    <a href="src/client/pages/product">CẦU CHI - CẢO HƯỚNG - BÀN ÉP PHANH HƯỚNG
                        ...
                        <div className="col-md-4 col-sm-6 wow fadeInUp "
                            ...
                            <a href="src/client/pages/product" className="item smooth">
                                ...
                                />
                                <div className="single-content text-center hiii">
                                    <a href="src/client/pages/product">LỌC - NHỚT - MỠ - NƯỚC LÀM MÁT</a>
                                </div>
                            </a>
                        </div>
                        ...
                        <div className="col-md-4 col-sm-6 wow fadeInUp "
                            ...
                            <a href="src/client/pages/product" className="item smooth">
                                ...
                                />
                                <div className="single-content text-center hiii">
                                    <a href="src/client/pages/product">PHỤ TÙNG MÁY KÉO NÔNG CỤ</a>
                                </div>
                            </a>
                        </div>
